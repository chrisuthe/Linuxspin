...
/// </summary>
/// <remarks>
/// This class is called from OpenAL's audio thread and must be fast and non-blocking.
...
public sealed class BufferedAudioSampleSource : IAudioSampleSource
{
    ...
    public int Read(float[] buffer, int offset, int count)
    {
        ...
        // Always return requested count to keep OpenAL happy (silence-filled if needed)
        return count;
    }
}
