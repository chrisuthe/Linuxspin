...
/// <summary>Pins that the gate acts on transitions and nothing else.</summary>
public sealed class RenderLoopGateTests
{
    [Fact]
    ...
    public void IsRunning_IsFalseBeforeFirstUpdate() =>
        Assert.False(new RenderLoopGate(() => { }, () => { }).IsRunning);
